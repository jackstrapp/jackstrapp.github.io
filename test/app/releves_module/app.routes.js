    ...
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild([
                ...
                { path: 'Releves/show', component: releve_compteur_list_component_1.ReleveCompteurListComponent, children: [
                        { path: '', component: empty_component_1.EmptyComponent },
                        { path: ':name', component: releve_list_component_1.ReleveListComponent }
                    ] },
