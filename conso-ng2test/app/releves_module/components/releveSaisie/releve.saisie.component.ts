...
export class AddReleveComponent implements OnInit, OnDestroy{
	...
	constructor(private route: ActivatedRoute, private router: Router,@Inject(CompteurService)private cptService: CompteurService, @Inject(ReleveService)private relService: ReleveService) {
	}
